...
const LocalCitationBlock: React.FC<LocalCitationBlockProps> = ({
  businessName  = 'ShieldLine Siding',
  address       = '600 N Valley Mills Dr, Waco, TX 76710',
  phone         = '(254) 890-9090',
  email         = 'hello@shieldlinesiding.com',
  googleMapsUrl = 'https://maps.google.com/?q=ShieldLine+Siding+Waco+TX',
  hours         = DEFAULT_HOURS,
  cityName      = 'Waco',
}) => {
  return (
      ...
      <div className={styles.container}>
        ...
        <div className={styles.header}>
          ...
          <p className={styles.subtitle}>
            Based in {cityName}, TX — serving all of Central Texas with licensed siding and exterior crews.
          </p>
        </div>
