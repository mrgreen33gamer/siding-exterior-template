...
const DEFAULT_ROWS: ComparisonRow[] = [
  { feature: 'Flat-rate quote before work starts',     us: true,  others: false },
  { feature: '3-Year workmanship warranty',            us: true,  others: false },
  { feature: 'HOA-friendly material options',          us: true,  others: 'Sometimes' },
  { feature: 'Licensed & insured crews',               us: true,  others: true },
  { feature: 'Daily site cleanup',                     us: true,  others: false },
  { feature: 'Material showcase & project gallery',    us: true,  others: false },
  { feature: 'Gate automation experience',             us: true,  others: 'Sometimes' },
...
export default function ValueComparison({ rows = DEFAULT_ROWS, title = 'ShieldLine vs. The Other Guys' }: ValueComparisonProps) {
  return (
