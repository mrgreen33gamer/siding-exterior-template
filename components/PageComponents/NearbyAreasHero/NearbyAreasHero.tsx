...
export default function NearbyAreasHero({
  ...
  const displayHeadline = headline ?? `Siding Service in ${cityName}, TX`;
  const displayDesc     = description ??
    `ShieldLine Siding provides siding and exterior installs for ${cityName} and surrounding communities. Licensed crews, flat-rate quotes, 10-Year Installation Warranty on every job.`;
    ...
    <section className={styles.section}>
      ...
      <div className={styles.container}>
        ...
        >
          ...
          <a href="tel:+12548909090" className={styles.phoneBtn}>
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
