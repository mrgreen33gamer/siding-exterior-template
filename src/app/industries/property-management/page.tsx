...
export default function IndustryPage() {
  const painPoints = [
    { icon: faClipboardList, problem: "Tenant tickets for damaged siding pile up", consequence: "Delays and callbacks cost more than doing the exterior right the first time." },
    { icon: faClipboardList, problem: "No photo documentation for ownership", consequence: "Owners and buyers notice inconsistent quality immediately." },
    { icon: faClipboardList, problem: "Inconsistent vendors per property", consequence: "Without documentation and a single accountable crew, problems repeat." },
    { icon: faClipboardList, problem: "Storm damage response is slow", consequence: "Shortcuts on weather barrier and flashing create leaks years later." },
  ...
  const faq = [
    { question: "Do you work with property management regularly?", answer: "Yes — property management projects are a core part of ShieldLine's Central Texas work." },
  ...
  return (
    <main className={styles.pageWrapper}>
      ...
      <SectionIntro
        title={"Property Management Exterior Solutions"}
        subtitle={"Portfolio siding repair, storm response, and reclads with documented visits and one invoice contact."}
      />
      ...
      <CTABanner
        headline={"Need a siding partner for property management?"}
      ...
      <div className={styles.section}>
        <Variant4 title={"Property Management Project Inquiry"} cityName="Waco" slug={"industries/" + "property-management"} spot={"property-management-industry-form"} formVariant={3} />
      </div>
    </main>
  );
}