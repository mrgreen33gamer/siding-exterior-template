...
export default function IndustryPage() {
  const painPoints = [
    { icon: faClipboardList, problem: "Siding delays hold CO", consequence: "Delays and callbacks cost more than doing the exterior right the first time." },
    { icon: faClipboardList, problem: "Inconsistent elevation specs across lots", consequence: "Owners and buyers notice inconsistent quality immediately." },
    { icon: faClipboardList, problem: "Punch-list callbacks after close", consequence: "Without documentation and a single accountable crew, problems repeat." },
    { icon: faClipboardList, problem: "Subs who miss weather barrier details", consequence: "Shortcuts on weather barrier and flashing create leaks years later." },
  ...
  const faq = [
    { question: "Do you work with homebuilders regularly?", answer: "Yes — homebuilders projects are a core part of ShieldLine's Central Texas work." },
  ...
  return (
    <main className={styles.pageWrapper}>
      ...
      <SectionIntro
        title={"Homebuilders Exterior Solutions"}
        subtitle={"Production and custom builder siding packages with schedule-aware crews and consistent specs."}
      />
      ...
      <CTABanner
        headline={"Need a siding partner for homebuilders?"}
      ...
      <div className={styles.section}>
        <Variant4 title={"Homebuilders Project Inquiry"} cityName="Waco" slug={"industries/" + "homebuilders"} spot={"homebuilders-industry-form"} formVariant={3} />
      </div>
    </main>
  );
}