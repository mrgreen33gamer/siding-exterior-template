...
// ShieldLine Siding — Contact Page (unique build, not just a form import)
...
// ── Service options ────────────────────────────────────────────────────────────
const SERVICES = [
  'Fiber Cement Siding', 'Vinyl Siding', 'Full-Home Reclad',
  'Siding Repair', 'Exterior Trim', 'Soffit & Fascia',
  'Other / Not Sure',
];
...
const faq = [
  {
    ...
    answer: "Call us directly at (254) 890-9090. We answer during business hours and evenings when crews are in the field. For storm-damaged siding or active leaks, call — don't wait on a form response.",
  },
  {
    question: 'How quickly can someone come out for an estimate?',
    answer: "Most free on-site estimates are scheduled within a few business days. We'll give you an honest timeline when you call — not a vague window.",
  },
  {
    question: 'Do you charge for the on-site estimate?',
    answer: 'No — the initial inspection and written quote are free. You\'ll know the flat-rate price before any work begins.',
  },
  {
    question: 'Do you work on commercial and multifamily properties?',
    answer: 'Yes — homebuilders, property managers, and multifamily exteriors are core work for ShieldLine. Call to discuss your property and schedule.',
  },
  {
  ...
  {
    question: 'How do I know if I need a repair or a full reclad?',
    answer: "We'll tell you honestly after the on-site look. If underlayment and framing are sound, sectional repair may be enough — if not, we'll show full reclad options with clear pricing.",
  },
];
// ── Main component ────────────────────────────────────────────────────────────
  ...
  return (
    <main className={styles.page}>
      ...
      <section className={styles.hero}>
        ...
        <div className={styles.heroInner}>
          <motion.div className={styles.heroBadge}
            ...
            Available 7 Days — Evenings Included
          </motion.div>
          <motion.h1 className={styles.heroTitle}
            initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.55, delay: 0.08 }}>
            Let&apos;s Get Your<br />
            <span className={styles.heroAccent}>Yard Looking Great</span>
          </motion.h1>
        ...
        <div className={styles.mainInner}>
          ...
          <div className={styles.leftCol}>
            ...
            <div className={styles.infoCards}>
              {[
                ...
                },
                {
                  ...
                  label:     'Email',
                  value:     'hello@shieldlinesiding.com',
                  href:      'mailto:hello@shieldlinesiding.com',
                ...
                },
                {
                  ...
                  label:     'Address',
                  value:     '600 N Valley Mills Dr, Waco TX 76710',
                  href:      'https://maps.google.com/?q=3311+Franklin+Ave+Waco+TX+76710',
            ...
            <div className={styles.trustBlock}>
              <p className={styles.trustHeading}>Why property owners choose ShieldLine Siding</p>
              {[
                'Flat-rate pricing — written quote before we start',
                '10-Year Installation Warranty on every job',
                'licensed crews only',
              ...
              {submitted ? (
                <motion.div key="success" className={styles.successCard}
                  ...
                  <p className={styles.successText}>
                    A ShieldLine Siding team member will reach out shortly — usually within one business day. For urgent needs, call us at{' '}
                    <a href="tel:+12548909090">(254) 890-9090</a>.
                  </p>
                  ...
                  <form className={styles.form} onSubmit={handleSubmit} noValidate>
                    ...
                    <div className={styles.field}>
                      ...
                      <textarea id="c-message" className={`${styles.input} ${styles.textarea}`}
                        ...
                        placeholder="What do you need done? Any specific areas of the property or timing to know about?"
      ...
      <CTABanner
        ...
        subline="Call (254) 890-9090 — we answer 7 days a week, evenings included. Serving all of Central Texas."
        primaryText="Call (254) 890-9090"
        primaryLink="tel:+12548909090"
        secondaryText="Send a Text"
        secondaryLink="sms:+12548909090"
      />
