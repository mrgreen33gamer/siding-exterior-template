// ShieldLine Siding — Vinyl Siding
"use client";
...
export default function ServicePage() {
  ...
  const localAreas = [
    { town: "Waco", benefit: "Home base — fastest scheduling for vinyl siding.", badge: "Home Base" },
  ...
  const faq = [
    { question: "Is vinyl siding a good choice for Central Texas?", answer: "Yes when you want lower maintenance and solid storm replaceability. We help compare vinyl vs fiber cement based on HOA rules, budget, and exposure." },
  ...
  return (
    <main className={styles.pageWrapper}>
      ...
      <SectionIntro
        title={"Vinyl Siding in Waco, TX"}
        subtitle={"Insulated and standard vinyl systems with proper J-channel, starter strips, and color-matched trim. A cost-effective exterior that handles Central Texas weather when installed correctly — no annual paint cycle required."}
      />
      ...
      <div className={styles.section}><LocalServiceAreas cityName="Waco" areas={localAreas} servicePath={"services/" + SLUG} title={"Vinyl Siding Across Central Texas"} /></div>
      <div className={styles.section}><ValueComparison rows={comparisonRows} /></div>
      <div className={styles.section}><FAQ cityName="Waco" faq={faq} title={"Vinyl Siding FAQs"} /></div>
      <CTABanner
      ...
      <div className={styles.section}>
        <Variant4 title={"Schedule Your Free Vinyl Siding Estimate"} cityName="Waco" slug={"services/" + SLUG} spot={SLUG + "-page-form"} formVariant={2} />
      </div>
    </main>
  );
}