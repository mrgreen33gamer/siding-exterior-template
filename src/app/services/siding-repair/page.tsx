// ShieldLine Siding — Siding Repair
"use client";
...
export default function ServicePage() {
  ...
  const localAreas = [
    { town: "Waco", benefit: "Home base — fastest scheduling for siding repair.", badge: "Home Base" },
  ...
  const faq = [
    { question: "Can you repair just one elevation?", answer: "Yes. Targeted repairs and partial replacements are common after hail or wind. We only recommend a full reclad when it is the better long-term value." },
  ...
  return (
    <main className={styles.pageWrapper}>
      ...
      <SectionIntro
        title={"Siding Repair in Waco, TX"}
        subtitle={"Storm damage, rot, failed panels, and leak paths — honest repair-vs-replace guidance. We document damage for insurance when needed, fix underlayment issues, and blend repairs so they disappear into the elevation."}
      />
      ...
      <div className={styles.section}><LocalServiceAreas cityName="Waco" areas={localAreas} servicePath={"services/" + SLUG} title={"Siding Repair Across Central Texas"} /></div>
      <div className={styles.section}><ValueComparison rows={comparisonRows} /></div>
      <div className={styles.section}><FAQ cityName="Waco" faq={faq} title={"Siding Repair FAQs"} /></div>
      <CTABanner
      ...
      <div className={styles.section}>
        <Variant4 title={"Schedule Your Free Siding Repair Estimate"} cityName="Waco" slug={"services/" + SLUG} spot={SLUG + "-page-form"} formVariant={2} />
      </div>
    </main>
  );
}