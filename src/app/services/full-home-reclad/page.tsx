// ShieldLine Siding — Full-Home Reclad
"use client";
...
export default function ServicePage() {
  ...
  const localAreas = [
    { town: "Waco", benefit: "Home base — fastest scheduling for full-home reclad.", badge: "Home Base" },
  ...
  const faq = [
    { question: "How long does a full-home reclad take?", answer: "Many homes finish in 2–4 weeks depending on size, weather, and product lead times. You get a realistic schedule at the quote." },
  ...
  return (
    <main className={styles.pageWrapper}>
      <Breadcrumb crumbs={[
        ...
        { label: "Full-Home Reclad" },
      ]} />
      <SectionIntro
        title={"Full-Home Reclad in Waco, TX"}
        subtitle={"Tear-off, weather barrier, siding, soffit, fascia, and trim — managed as one coordinated project. One crew, one schedule, one warranty path. We stage elevations so your home is never left open overnight."}
      />
      ...
      <div className={styles.section}><LocalServiceAreas cityName="Waco" areas={localAreas} servicePath={"services/" + SLUG} title={"Full-Home Reclad Across Central Texas"} /></div>
      <div className={styles.section}><ValueComparison rows={comparisonRows} /></div>
      <div className={styles.section}><FAQ cityName="Waco" faq={faq} title={"Full-Home Reclad FAQs"} /></div>
      <CTABanner
      ...
      <div className={styles.section}>
        <Variant4 title={"Schedule Your Free Full-Home Reclad Estimate"} cityName="Waco" slug={"services/" + SLUG} spot={SLUG + "-page-form"} formVariant={2} />
      </div>
    </main>
  );
}