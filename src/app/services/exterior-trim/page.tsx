// ShieldLine Siding — Exterior Trim
"use client";
...
export default function ServicePage() {
  ...
  const localAreas = [
    { town: "Waco", benefit: "Home base — fastest scheduling for exterior trim.", badge: "Home Base" },
  ...
  const faq = [
    { question: "PVC or wood trim?", answer: "PVC and cellular PVC resist rot and insects with less maintenance. We still use wood when a historic detail requires it and discuss trade-offs up front." },
  ...
  return (
    <main className={styles.pageWrapper}>
      ...
      <SectionIntro
        title={"Exterior Trim in Waco, TX"}
        subtitle={"PVC and painted trim packages for windows, corners, frieze, and architectural details. Rot-proof trim that holds paint and crisp profiles — ideal for Texas humidity and historic-looking homes that need modern durability."}
      />
      ...
      <div className={styles.section}><LocalServiceAreas cityName="Waco" areas={localAreas} servicePath={"services/" + SLUG} title={"Exterior Trim Across Central Texas"} /></div>
      <div className={styles.section}><ValueComparison rows={comparisonRows} /></div>
      <div className={styles.section}><FAQ cityName="Waco" faq={faq} title={"Exterior Trim FAQs"} /></div>
      <CTABanner
      ...
      <div className={styles.section}>
        <Variant4 title={"Schedule Your Free Exterior Trim Estimate"} cityName="Waco" slug={"services/" + SLUG} spot={SLUG + "-page-form"} formVariant={2} />
      </div>
    </main>
  );
}