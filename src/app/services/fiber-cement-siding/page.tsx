// ShieldLine Siding — Fiber Cement Siding
"use client";
...
const SLUG = "fiber-cement-siding";
...
export default function ServicePage() {
  ...
  const localAreas = [
    { town: "Waco", benefit: "Home base — fastest scheduling for fiber cement siding.", badge: "Home Base" },
  ...
  const faq = [
    { question: "How much does fiber cement siding cost in Waco?", answer: "Most projects range by square footage, elevation complexity, and finish. We measure on site and provide a flat-rate written quote before work starts." },
  ...
  return (
    <main className={styles.pageWrapper}>
      ...
      <SectionIntro
        title={"Fiber Cement Siding in Waco, TX"}
        subtitle={"Durable fiber cement lap, panel, and board-and-batten systems built for Texas heat and hail. Factory-finish and field-paint options, proper weather barriers, and manufacturer-spec installs so product warranties stay valid."}
      />
      ...
      <div className={styles.section}><LocalServiceAreas cityName="Waco" areas={localAreas} servicePath={"services/" + SLUG} title={"Fiber Cement Siding Across Central Texas"} /></div>
      <div className={styles.section}><ValueComparison rows={comparisonRows} /></div>
      <div className={styles.section}><FAQ cityName="Waco" faq={faq} title={"Fiber Cement Siding FAQs"} /></div>
      <CTABanner
      ...
      <div className={styles.section}>
        <Variant4 title={"Schedule Your Free Fiber Cement Siding Estimate"} cityName="Waco" slug={"services/" + SLUG} spot={SLUG + "-page-form"} formVariant={2} />
      </div>
    </main>
  );
}